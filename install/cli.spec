...
a = Analysis(['cli.py'],
             ...
             hiddenimports=['PySide2.QtPrintSupport','PySide2.QtWebChannel','PySide2.QtWebEngineCore','PySide2.QtQuick', 'pyproj', 'pyproj.datadir', 'hyo2.abc', 'hyo2.mate','hyo2.qax','hyo2.mate.qax.plugin', 'hyo2.qax.plugins.test', 'hyo2.qax.plugins.placeholder', 'ausseabed.mbesgc', 'ausseabed.mbesgc.qax.plugin', 'ausseabed.findergc', 'ausseabed.findergc.qax.plugin'],
             hookspath=[hooks_dir],
             runtime_hooks=[],
             excludes=[],
