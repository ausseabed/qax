...
class TestParser(unittest.TestCase):
    ...
    def test_summary_heading_label(self):
        ...
        self.assertEqual(summary.summary_heading_label, 'Xi1039_B11_MBES')

        fn = 'Xi1039_B12_MBES_c1m_LAT_Prelim_r4_MULTI_crop.tif'
        summary = QajsonFileSummary(fn)
        self.assertEqual(summary.summary_heading_label, 'Xi1039_B12_MBES')

        fn = 'Xi1039 B12 MBES c1m LAT Prelim r4_MULTI_crop.tif'
        summary = QajsonFileSummary(fn)
        self.assertEqual(summary.summary_heading_label, 'Xi1039 B12 MBES')
    ...
    def test_get_safe_shortname(self):
        ...
        self.assertEqual(safe_name, 'Xi1039_B11_MBES')
        ...
        self.assertEqual(safe_name, 'Xi1039_B11_MBES (1)')
        ...
        self.assertEqual(safe_name, 'Zi1039_B11_MBES')
