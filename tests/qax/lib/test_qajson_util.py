...
class TestParser(unittest.TestCase):
    def test_qajson_read(self):
        ...
        exporter.export(qajson, file=output_file, plugins=profile_plugins)
    ...
    def test_summary_heading_label(self):
        ...
        summary = QajsonFileSummary(fn)
        self.assertEqual(
            summary.summary_heading_label, "Xi1039B12MBESc1mLATPrelimr4MULTIcrop"
        )

        fn = "a-b.tif"
        summary = QajsonFileSummary(fn)
        self.assertEqual(summary.summary_heading_label, "a-b")
